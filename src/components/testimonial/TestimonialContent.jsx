...
export const TestimonialContent = ({ triggerModal, navigateTo }) => {
  ...
  const videoStories = [
    { id: 0, title: 'Video Story: Arjun Sharma', src: media.video_arjun, duration: '3:20' },
    { id: 1, title: 'Video Story: Priya Rathore', src: media.video_priya, duration: '2:50' },
    { id: 2, title: 'Video Story: Vikram Panwar', src: media.video_vikram, duration: '4:10' },
    { id: 3, title: 'Video Story: Karan Bhati', src: media.video_karan, duration: '4:45' },
    { id: 4, title: 'Video Story: Anjali Sharma', src: media.video_anjali, duration: '3:40' }
  ];
  return (
    <>
      ...
      <section className="testimonial-intro-section" style={{ paddingTop: '120px' }}>
        <div className="container testimonial-intro-grid">
          <div className="testimonial-intro-text">
            ...
            <div className="testimonial-intro-graphic" style={{ marginTop: '3rem' }}>
                  ...
                  >
                    <div className="video-thumbnail-wrapper">
                      <video 
                        ...
                        onClick={(e) => {
                          if (isPlaying) {
                            e.stopPropagation(); // Stop click from triggering parent card's onClick
                          }
                        }}
                        onPause={() => {
                          if (isPlaying) {
                      ...
                      {!isPlaying && (
                        <>
                          ...
                          <span className="video-duration">{videoDurations[index] || story.duration}</span>
                        </>
                      )}
                    </div>
                  </div>
