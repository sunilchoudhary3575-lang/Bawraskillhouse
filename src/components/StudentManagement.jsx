        ...
        <div>
          ...
          <div className="printable-registration-form" ref={printRef}>
            ...
            <div className="terms-page-container">
              <div className="terms-inner-box" style={{
                border: '1.5px solid #0f172a',
                borderRadius: '8px',
                padding: '10px 14px',
                boxSizing: 'border-box'
                ...
                <div style={{ textAlign: 'center', marginBottom: '6px', borderBottom: '2px solid #0f172a', paddingBottom: '4px' }}>
                  <h2 style={{ margin: '0 0 2px 0', fontSize: '1.15rem', fontWeight: '900', color: '#0a0e29', letterSpacing: '0.8px', textTransform: 'uppercase' }}>
                    BAWRA SKILL HOUSE
                  </h2>
                  <h3 style={{ margin: 0, fontSize: '0.85rem', fontWeight: '800', color: '#e11d48', letterSpacing: '0.5px', textTransform: 'uppercase' }}>
                    STUDENT TERMS & CONDITIONS
                  </h3>
                </div>

                {/* Summary Info Table */}
                <table style={{ width: '100%', borderCollapse: 'collapse', marginBottom: '6px', fontSize: '0.72rem' }}>
                  <tbody>
                    <tr>
                      <td style={{ border: '1px solid #cbd5e1', padding: '3px 6px', background: '#f8fafc', width: '50%', fontWeight: '600' }}>
                    ...
                    <tr>
                      <td style={{ border: '1px solid #cbd5e1', padding: '3px 6px', background: '#f8fafc', fontWeight: '600' }}>
                ...
                <p style={{ fontSize: '0.70rem', color: '#334155', margin: '0 0 6px 0', fontStyle: 'italic', fontWeight: '500' }}>
                ...
                {/* Terms Points */}
                <div className="terms-points-list" style={{ fontSize: '0.70rem', color: '#0f172a', lineHeight: '1.3' }}>
                  <div style={{ marginBottom: '3.5px' }}>
                    <strong style={{ color: '#0a0e29', fontSize: '0.73rem' }}>1. Course Duration & Classes</strong>
                  ...
                  <div style={{ marginBottom: '3.5px' }}>
                    <strong style={{ color: '#0a0e29', fontSize: '0.73rem' }}>2. Course Fees</strong>
                    <ul style={{ margin: '1px 0 0 14px', padding: 0 }}>
                  ...
                  <div style={{ marginBottom: '3.5px' }}>
                    <strong style={{ color: '#0a0e29', fontSize: '0.73rem' }}>3. Attendance</strong>
                    <ul style={{ margin: '1px 0 0 14px', padding: 0 }}>
                  ...
                  <div style={{ marginBottom: '3.5px' }}>
                    <strong style={{ color: '#0a0e29', fontSize: '0.73rem' }}>4. Teacher / Trainer</strong>
                    <ul style={{ margin: '1px 0 0 14px', padding: 0 }}>
                  ...
                  <div style={{ marginBottom: '3.5px' }}>
                    <strong style={{ color: '#0a0e29', fontSize: '0.73rem' }}>5. Course & Schedule</strong>
                    <ul style={{ margin: '1px 0 0 14px', padding: 0 }}>
                  ...
                  <div style={{ marginBottom: '3.5px' }}>
                    <strong style={{ color: '#0a0e29', fontSize: '0.73rem' }}>6. Certificate</strong>
                    <ul style={{ margin: '1px 0 0 14px', padding: 0 }}>
                  ...
                  <div style={{ marginBottom: '3.5px' }}>
                    <strong style={{ color: '#0a0e29', fontSize: '0.73rem' }}>7. Job / Placement</strong>
                    <ul style={{ margin: '1px 0 0 14px', padding: 0 }}>
                  ...
                  <div style={{ marginBottom: '3.5px' }}>
                    <strong style={{ color: '#0a0e29', fontSize: '0.73rem' }}>8. Student Behaviour</strong>
                    <ul style={{ margin: '1px 0 0 14px', padding: 0 }}>
                  ...
                  <div style={{ marginBottom: '3.5px' }}>
                    <strong style={{ color: '#0a0e29', fontSize: '0.73rem' }}>9. Course Material</strong>
                    <ul style={{ margin: '1px 0 0 14px', padding: 0 }}>
                  ...
                  <div style={{ marginBottom: '4px' }}>
                    <strong style={{ color: '#0a0e29', fontSize: '0.73rem' }}>10. Student Declaration</strong>
                    <p style={{ margin: '1px 0 0 0', fontStyle: 'italic', color: '#334155' }}>
                ...
                <div className="terms-sig-box" style={{ border: '1px solid #cbd5e1', borderRadius: '6px', padding: '6px 10px', background: '#f8fafc', marginTop: '4px' }}>
                  <div style={{ display: 'flex', alignItems: 'center', gap: '6px', marginBottom: '4px', fontWeight: 'bold', fontSize: '0.72rem', color: '#0f172a' }}>
