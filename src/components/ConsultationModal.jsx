...
export const ConsultationModal = ({
  ...
  const isEnquiryMode = selectedCourse === 'Enquiry';
        ...
        <div className="modal-content premium-modal" onClick={(e) => e.stopPropagation()}>
          ...
          <div className="premium-modal-header">
            <span className="premium-badge">
              ...
              {isEnquiryMode ? 'Quick Enquiry' : 'Bawra Career Hub'}
            </span>
            <h3>{isEnquiryMode ? 'Submit Your Enquiry' : 'Book Your Free Career Call'}</h3>
            <p>{isEnquiryMode ? 'Enter your details below and we will contact you shortly.' : 'Agla success story tumhara ho sakta hai. Start today!'}</p>
          </div>
